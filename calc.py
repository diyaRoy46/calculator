...
btn8=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='8',command=lambda:btn(8)).grid(row=1, column=1)
btn9=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='9',command=lambda:btn(9)).grid(row=1, column=2)
btnC=Button(root,padx=30,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='C',bg='yellow',command=Clear).grid(row=1, column=3)
...
btn5=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='5',command=lambda:btn(5)).grid(row=2, column=1)
btn6=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
...
btn2=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='2',command=lambda:btn(2)).grid(row=3, column=1)
btn3=Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
...
btndot=Button(root,padx=38,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='.',bg='orange',command=lambda:btn('.')).grid(row=4, column=1)
btndivision=Button(root,padx=40,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='/',bg='orange',command=lambda:btn('/')).grid(row=4, column=2)
btnmultiply=Button(root,padx=36,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
...
btnequals=Button(root,padx=95,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
            text='=',command=Equal).grid(row=5, column=0,columnspan=2)
btnopenbracket=Button(root,padx=40,pady=15,bd=8,fg='black',font=('arial',30,'bold'),
